...
<body class="home-layout bg-[#fbfaf7] dark:bg-[#050505]">
    ...
    <main class="item px-3 pb-10 pt-4 sm:px-5 md:px-6 lg:px-8">
        ...
        <section
            class="mx-auto max-w-5xl rounded-2xl border border-[#eadfce] bg-white p-5 dark:border-[#27211a] dark:bg-[#090909]">
                    ...
                    <article class="rounded-lg border p-4 {{ $cardClass }}">
                        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <a href="{{ route('reservations.show', $reservation->id) }}"
                                class="inline-flex min-h-10 items-center justify-center rounded-lg bg-[#FE6807] px-4 text-sm font-semibold text-white">Ver
                                empréstimo</a>
                        </div>
                    </article>
                @empty
                    <div
                        class="rounded-lg border border-[#eadfce] bg-[#fffaf5] p-6 text-center text-sm font-semibold text-[#66594d] dark:border-[#332820] dark:bg-[#0f0d0b] dark:text-[#cfc5ba]">
