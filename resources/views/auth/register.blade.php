...
<body class="auth-page" style="--auth-background-image: url('{{ asset('img/svg/loginbc.svg') }}')">
    ...
    <div class="login-container">
            ...
            <div class="auth-grid auth-grid--two">
                <label class="auth-field">
                    ...
                    <span class="field-shell block">
                        ...
                        <input class="premium-input" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Digite o seu nome" autocomplete="name">
                    </span>
                ...
                <label class="auth-field">
                    ...
                    <span class="field-shell block">
                        ...
                        <input class="premium-input" type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Digite o seu email" autocomplete="email">
                    </span>
            ...
            <div class="auth-grid auth-grid--two">
                <label class="auth-field">
                    ...
                    <span class="field-shell block">
                        ...
                        <input class="premium-input" type="password" name="password" id="password" placeholder="Digite a sua palavra-passe" autocomplete="new-password">
                    </span>
                ...
                <label class="auth-field">
                    ...
                    <span class="field-shell block">
                        ...
                        <input class="premium-input" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirme a palavra-passe" autocomplete="new-password">
                    </span>
                </label>
            </div>
        ...
        <p class="register-text">Já tem conta? <a href="{{ route('login') }}">Entrar</a></p>
    </div>
</body>
</html>
